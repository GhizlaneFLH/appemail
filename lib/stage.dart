...
class EmailListstage extends StatefulWidget {
  @override
  _EmailListScreenState createState() => _EmailListScreenState();
}

class _EmailListScreenState extends State<EmailListstage> {
  List<Email> emailList = [];

  Future<void> fetchEmails() async {
    var url = 'http://192.168.0.183/TEMACONCEPT/stagefetch.php';
    final response =
