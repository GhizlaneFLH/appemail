...
class AllEmail extends StatefulWidget {
  @override
  _AllEmailsState createState() => _AllEmailsState();
}

class _AllEmailsState extends State<AllEmail> {
                    ...
                    return Column(
                      ...
                      children: <Widget>[
                        ListTile(
                          ...
                          onTap: () {
                            // Action à effectuer lorsque "Plus récent" est sélectionné
                            // Tri des emails par date (plus récent en premier)
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            // Action à effectuer lorsque "Plus ancien" est sélectionné
                            // Tri des emails par date (plus ancien en premier)
                            emailList.sort((a, b) => a.date.compareTo(b.date));
                            Navigator.pop(context); // Fermer le menu
                          },
                        ),
                      ],
