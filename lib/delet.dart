...
class EmailListdelet extends StatefulWidget {
  @override
  _EmailListScreenState createState() => _EmailListScreenState();
}

class _EmailListScreenState extends State<EmailListdelet> {
  List<Email> emailList = [];

  Future<void> fetchEmails() async {
    var url = 'http://192.168.0.183/TEMACONCEPT/deletfetch.php';
    final response =
        await http.get(Uri.parse(url)); // Replace with your API endpoint
